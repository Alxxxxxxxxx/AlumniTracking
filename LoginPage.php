        ...
        <h1>
              ...
              <h2>
                  HOME OF THE MEEK AND HUMBLE
                        ...
                        <div class="arrow-back d-inline">
                                <a class="page-link" href="landingpage.php"><i class="fa-solid fa-chevron-left me-1" style="height: 20px; margin-top: 2em; margin-left: 2em;"></i>Back</a>
                        </div>
                                <div class="text-center">
                                    <img src="images/logo.png" style="width: 185px;" alt="logo">
                                    <h2 class="custom-text-color">Welcome to SHJCS Alumni Tracking System!</h2>
                                    <p class="font-weight-bolder ">Home of the Meek and Humble</p>
                                </div>

                                <form id="loginForm" method="POST" action="" onsubmit="handleSubmit(event)">
                                    <p>Please login to your account</p>

                                    <div data-mdb-input-init class="form-outline ">
                                        <input type="text" name="id" id="id" pattern="[0-9]{6}" placeholder="user id" maxlength="6" class="form-control" required/>
                                        <p>*Username</p>
                                    </div>
                                    ...
                                    <div class="form-check">
                                        <div class="g-recaptcha" data-sitekey="6Le-OhwqAAAAAFWys2NHZ6xyrRaV0f136g-Ns1wM"></div>
                                    </div>

                                    <div class="text-center">
                                        <button data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block " type="submit">Log in</button>
                                    </div>
                                </form>
</form>
