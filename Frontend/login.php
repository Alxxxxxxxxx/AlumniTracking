...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!$responseData->success) {
        ...
        if ($rowAdmin && password_verify($password, $rowAdmin['password'])) {
            ...
            if (
                !empty($rowAlumni['last_name']) && 
                !empty($rowAlumni['first_name']) && 
                !empty($rowAlumni['present_address']) && 
                !empty($rowAlumni['contact_number']) && 
                !empty($rowAlumni['current_status']) && 
                !empty($rowAlumni['university_employer']) && 
                !empty($rowAlumni['position_year_level']) && 
                !empty($rowAlumni['type_of_employment']) && 
                !empty($rowAlumni['year_hired']) && 
                !empty($rowAlumni['strand'])
            ) {
